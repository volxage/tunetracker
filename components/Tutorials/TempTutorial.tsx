  ...
  return(
    <SafeBgView>
      <ScrollView>
        ...
        <SubText>Playlists allow you to organize like tunes together. You can select a playlist you already created, or you can switch modes and create a new playlist.</SubText>
